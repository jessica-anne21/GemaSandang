...
<div class="container-fluid">
    ...
    <div class="row g-4">
        <div class="col-lg-4">
            <div class="card shadow-sm border-0 mb-4" style="border-radius: 0.75rem;">
                <div class="card-body text-center p-4">
                    <div class="rounded-circle text-white d-flex justify-content-center align-items-center mx-auto mb-3 shadow" 
                         style="width: 100px; height: 100px; font-size: 3rem; font-weight: bold; background-color: #800000;">
            ...
            <div class="card shadow-sm border-0 text-white" style="border-radius: 0.75rem; background: linear-gradient(135deg, #800000, #a05d69);">
        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0 h-100" style="border-radius: 0.75rem;">
                <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                    <h6 class="mb-0 fw-bold text-uppercase" style="color: #800000;">
